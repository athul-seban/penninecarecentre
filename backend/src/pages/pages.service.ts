...
const DEFAULT_PAGES = [
  ...
  },
  {
    ...
    sections: {
      ...
      wellnessImage: '',
      featuresTitle: 'Why Choose the Pennine Suite?',
      ...
      featureTeamText: 'Our carefully selected care team are passionate, highly trained, and committed to making every resident feel valued, safe, and genuinely cared for every single day.',
      featureEnvironment: 'Fresh Environment',
      featureEnvironmentText: 'As a newly built, purpose-designed home, Pennine Care offers a modern, bright, and immaculately maintained environment — setting a new standard for residential care in the region.',
      galleryImages: [
        '/assets/images/pennine-suite-quality-care.png',
  ...
  },
  {
    ...
    sections: {
      ...
      modernisationImage: '',
      featuresTitle: 'Why Choose the Moorland Suite?',
      featureCost: 'Transparent Fees',
      featureCostText: 'We set out our fee structure clearly from the outset, so families have complete clarity from day one.',
      featureTeam: 'Dedicated Team',
  ...
  },
  {
    ...
    sections: {
      headerImage: '/assets/images/pennine-suite-interior.png',
      heroSubtitle: 'Your Data & Peace of Mind',
      heroTitle: 'Privacy Policy',
      lastUpdated: 'Last Updated: September 5, 2026',
      introTitle: 'Information Governance & Compliance',
      introText: 'At Pennine Care Centre, we are dedicated to protecting the privacy, dignity, and personal data of our residents, their families, and our staff. This policy describes how we collect, store, and process personal and sensitive information in accordance with the General Data Protection Regulation (GDPR) and the UK Data Protection Act 2018.',
      collectTitle: '1. Information We Collect',
      collectIntro: 'To deliver exceptional care and safety, we collect and process certain personal information, which may include:',
      collectItem1Label: 'Personal Details',
      collectItem1Text: 'Names, contact details, dates of birth, and next-of-kin information.',
      collectItem2Label: 'Health & Medical Records',
      collectItem2Text: 'Medical histories, clinical assessments, dietary needs, care plans, and medication administration records.',
      collectItem3Label: 'Financial Information',
      collectItem3Text: 'Billing addresses, bank details, and funding support data for invoicing purposes.',
      collectItem4Label: 'Digital Data',
      collectItem4Text: 'Submission details from our contact and job application forms, and basic website usage data (page visited, referring page, browser type, and a masked IP address that does not identify you individually) collected automatically when you browse our site. See "Cookies & Website Analytics" below for full detail.',
      useTitle: '2. How We Use Your Information',
      useIntro: 'We use your personal data strictly to fulfil legal, clinical, and administrative requirements, including:',
      useItem1: 'Creating, updating, and delivering custom person-centred care plans.',
      useItem2: 'Ensuring emergency medical practitioners have precise and quick clinical references.',
      useItem3: 'Managing billing, payroll for our employees, and operational compliance.',
      useItem4: 'Responding directly to enquiries submitted through our website and application forms.',
      retentionTitle: '3. Data Retention & Protection',
      retentionText1: 'All digital data is encrypted using advanced Secure Socket Layer (SSL) protocols. Physical records are kept in secure, restricted-access cabinets. We retain information only for as long as required by law, Care Quality Commission (CQC) standards, or to maintain care continuity.',
      retentionText2: 'We use reputable third-party providers to host our website, database, and email services, and to store photographs and documents such as CVs. These providers act as our data processors, are based in the UK/EU or hold equivalent data-protection safeguards, and may only use your data to provide these services to us.',
      cookiesTitle: '4. Cookies & Website Analytics',
      cookiesIntro: 'Our website does not use third-party advertising or tracking cookies, and no consent banner is shown because we only use the following, which do not identify you personally:',
      cookiesItem1Label: 'Local storage (your device only)',
      cookiesItem1Text: 'A remembered choice if you dismiss the announcement banner, and your display theme preference. These stay on your own device and are never sent to us.',
      cookiesItem2Label: 'First-party website analytics',
      cookiesItem2Text: 'When you visit a page, our server automatically logs the page path, the referring page, and your browser\'s user agent, together with your IP address masked so the last part is removed (e.g. 203.0.113.0 rather than your full address) before it is stored. This is used only in aggregate, to understand which pages are useful and improve the site, under our legitimate interest in operating and improving our website.',
      rightsTitle: '5. Your Rights',
      rightsIntro: 'Under UK data protection laws, you retain extensive rights regarding your data. You may request to:',
      rightsItem1: 'Access the personal records we hold about you.',
      rightsItem2: 'Rectify any mistakes or update outdated information.',
      rightsItem3: 'Object to or restrict the processing of non-essential data.',
      rightsItem4: 'Request deletion of data, subject to nursing and medical retention statutory regulations.',
      contactTitle: '6. Contact Our Data Controller',
      contactIntro: 'If you have any questions or would like to submit a Subject Access Request (SAR), please contact our Data Governance Officer at:',
